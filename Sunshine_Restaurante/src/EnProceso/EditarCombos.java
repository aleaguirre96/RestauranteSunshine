 ...
 * @author danip
 */
public class EditarCombos extends javax.swing.JFrame {

    /**
     * Creates new form EditarCombos
     */
    public EditarCombos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarCombos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarCombos().setVisible(true);
            }
        });
    }
